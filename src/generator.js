...
import { default as RewritingStream } from 'parse5-html-rewriting-stream';

import { markdown } from './markdown.js';

export async function loadPageTemplate(filePath) {
...
export async function generateNavigatorRenderer(pages) {
  const names = [];
...
export async function generateMarkdownRenderer(filePath) {
...
export async function generateIndexRenderer(metadatas) {
